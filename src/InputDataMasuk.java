 ...
 * @author ACER
 */
public class InputDataMasuk extends javax.swing.JFrame {

    /**
     * Creates new form InputDataMasuk
     */
    public InputDataMasuk() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputDataMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InputDataMasuk().setVisible(true);
            }
        });
    }
